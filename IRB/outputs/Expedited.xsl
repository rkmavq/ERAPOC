				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block widows="2" orphans="2" font-size="10pt" line-height="1.147" white-space-collapse="false">						
                                    ...
                                    <fo:table-cell padding-top="0pt" padding-left="0pt"
                                        ...
                                        <fo:block-container>
                                            <fo:block font-family="Arial" font-size="10pt"
                                                ...
                                                <fo:inline font-family="Arial"
                                                    letter-spacing="-0.15pt" font-size="10pt"
                                                    ><fo:leader leader-length="0pt"/><xsl:value-of select="$revProcess"/></fo:inline>
                                            </fo:block>
                                        </fo:block-container>
                                    </fo:table-cell>
                                </fo:table-row>
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>This submission has received expedited review based on applicable federal regulations 45 CFR 46.110(b)<xsl:value-of select="//latestExpeditedCats"/><!-- <xsl:value-of select="//latestExpeditedCats"/>-->.</fo:inline>                            
                        </fo:block>
					    ...
					    <xsl:if test="obtainingHIPAAAuthorization!='1' and requestingWaiverAlteration!='1'">
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
                        </fo:block>
					    ...
					    <xsl:if test="obtainingHIPAAAuthorization='1' or requestingWaiverAlteration='1'">
					        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
					            text-indent="36pt" letter-spacing="-0.15pt">
					            <fo:leader/>
					        </fo:block>
					        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
					            ...
					            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
					            xmlns:svg="http://www.w3.org/2000/svg">
					            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>The IRB has determined that a waiver/alteration of consent under 45 CFR 46.116(f)<xsl:value-of select="//latestExpeditedCats"/> and/or 45 CFR 46.117(c)(1)<xsl:value-of select="//latestExpeditedCats"/> is appropriate for this study.</fo:inline>
					        </fo:block>
					        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
					            text-indent="36pt" letter-spacing="-0.15pt">
					            <fo:leader/>
					        ...
					        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
					            ...
					            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
					            xmlns:svg="http://www.w3.org/2000/svg">
					            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>The IRB also determined that a waiver of the HIPAA Authorization Statement is appropriate under 45 CFR 46.160 and 164.</fo:inline>
					        </fo:block>
					    </xsl:if>
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>This project has been determined to be a MINIMAL RISK project. Based on the risks, this project does not require continuing review by this committee on an annual basis. A final report must be submitted upon completion of the research. Please use the appropriate forms for this procedure.</fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
