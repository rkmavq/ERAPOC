					...
					<fo:block widows="2" orphans="2" font-size="10pt" line-height="1.147" white-space-collapse="false">						
                        ...
                        <fo:table font-family="Arial" language="EN-US" start-indent="0pt">
                            ...
                            <fo:table-body start-indent="0pt" end-indent="0pt">
                                    ...
                                    <fo:table-cell padding-top="0pt" padding-left="0pt"
                                        ...
                                        <fo:block-container>
                                            <fo:block font-family="Arial" font-size="10pt"
                                                ...
                                                <fo:inline font-family="Arial"
                                                    letter-spacing="-0.15pt" font-size="10pt"
                                                    ><fo:leader leader-length="0pt"/>ACKNOWLEDGED</fo:inline>
                                            </fo:block>
                                        </fo:block-container>
                                    </fo:table-cell>
                                </fo:table-row>
                                ...
                                <xsl:if test="$endDate!='' and $endDate!='undefined'">
                                <fo:table-row>
                                    <fo:table-cell padding-top="0pt" padding-left="0pt"
                                        padding-bottom="0pt" padding-right="5.4pt">
                                        <fo:block-container>
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>Thank you for your submission of <xsl:value-of select="$subName"/> materials for this project.The HonorHealth IRB has ACKNOWLEDGED your submission. No further action is required at this time. A copy of this letter and submitted items will be maintained in our records.</fo:inline>                                           
                        </fo:block>
