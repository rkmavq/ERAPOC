				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block widows="2" orphans="2" font-size="10pt" line-height="1.147" white-space-collapse="false">						
                                    ...
                                    <fo:table-cell padding-top="0pt" padding-left="0pt"
                                        ...
                                        <fo:block-container>
                                            <fo:block font-family="Arial" font-size="10pt"
                                                ...
                                                <fo:inline font-family="Arial"
                                                    letter-spacing="-0.15pt" font-size="10pt"
                                                    ><fo:leader leader-length="0pt"/>MODIFICATIONS REQUIRED</fo:inline>
                                            </fo:block>
                                        </fo:block-container>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row>
                                    <fo:table-cell padding-top="0pt" padding-left="0pt"
                                        ...
                                        <fo:block-container>
                                            <fo:block font-family="Arial" font-size="10pt"
                                                language="EN-US" keep-with-next.within-page="always">
                                                <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>DECISION DATE:</fo:inline>
                                            </fo:block>
                                        </fo:block-container>
                                    </fo:table-cell>
                                    <fo:table-cell padding-top="0pt" padding-left="0pt"
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>Thank you for your submission of <xsl:value-of select="$subName"/> materials for this project. The HonorHealth IRB has determined that the following MODIFICATIONS are REQUIRED in order to secure approval:</fo:inline>                                           
                        </fo:block>
					    <fo:block font-family="Arial" font-size="10pt" language="EN-US"
					        text-indent="36pt" letter-spacing="-0.15pt">
					        <fo:leader/>
					    ...
					    <!-- 
							wmalyk2021-10-15 - these fixes to allow the "returns to work"
					    	added the white-space-collapse white-space-treatment linefeed-treatment attributes
					    	and replaced text-indent with margin-left so the wrapped text wouldn't go back to the left margin
					    -->
					    <fo:block space-after="7pt" space-after.conditionality="retain" margin-left="26pt"
					        ...
					        <fo:inline>
					            <fo:leader leader-length="0pt"/>								
					            <xsl:value-of select="instructionsToInvestigator"/>
					        </fo:inline>
					    </fo:block>
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>Research activities in accordance with this submission may not begin until the IRB has received a response to these conditions and issued final approval.</fo:inline>                            
                        </fo:block>
