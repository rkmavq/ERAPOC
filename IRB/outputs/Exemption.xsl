				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block widows="2" orphans="2" font-size="10pt" line-height="1.147" white-space-collapse="false">						
                                    ...
                                    <fo:table-cell padding-top="0pt" padding-left="0pt"
                                        ...
                                        <fo:block-container>
                                            <fo:block font-family="Arial" font-size="10pt"
                                                ...
                                                <fo:inline font-family="Arial"
                                                    letter-spacing="-0.15pt" font-size="10pt"
                                                    ><fo:leader leader-length="0pt"/>DETERMINATION OF EXEMPT STATUS</fo:inline>
                                            </fo:block>
                                        </fo:block-container>
                                    </fo:table-cell>
                                </fo:table-row>
                                ...
                                <fo:table-row>
                                    <fo:table-cell padding-top="0pt" padding-left="0pt"
                                        ...
                                        <fo:block-container>
                                            <fo:block font-family="Arial" font-size="10pt"
                                                language="EN-US" keep-with-next.within-page="always">
                                                <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>REVIEW CATEGORY:</fo:inline>
                                            </fo:block>
                                        </fo:block-container>
                                    </fo:table-cell>
                                    <fo:table-cell padding-top="0pt" padding-left="0pt"
                                        ...
                                        <fo:block-container>
                                                <fo:block>
                                                    <fo:inline><fo:leader leader-length="0pt"/>
                                                        <fo:leader leader-length="0pt"/><fo:leader leader-length="0pt"/>Exemption category 45 CFR 46.104(d) <xsl:value-of select="//exemptCats"/></fo:inline>
                                                </fo:block>                                            
                                        </fo:block-container>
                                    </fo:table-cell>
                                </fo:table-row>
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>Thank you for your submission of NEW PROJECT materials for this project. The HonorHealth Institutional Review Board has determined this project is EXEMPT FROM IRB REVIEW according to federal regulations.</fo:inline>                                           
                        </fo:block>
					    ...
					    <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
					        ...
					        xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
					        xmlns:svg="http://www.w3.org/2000/svg">
					        <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>We will retain a copy of this correspondence within our records.</fo:inline>                            
					    </fo:block>
					    <fo:block font-family="Arial" font-size="10pt" language="EN-US"
					        text-indent="36pt" letter-spacing="-0.15pt">
					        <fo:leader/>
