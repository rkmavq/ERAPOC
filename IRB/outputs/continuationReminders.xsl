                ...
                <fo:block id="IDAKIOTD" xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                    ...
                    <fo:block id="IDALIOTD">
                        <fo:table xmlns:st1="urn:schemas-microsoft-com:office:smarttags" xmlns:svg="http://www.w3.org/2000/svg" font-family="Calibri" language="EN-IN" start-indent="0pt">
                            <fo:table-column column-number="1" column-width="194pt"/>
							...
							<xsl:choose>
								<xsl:when test="remType = 'rem30'">
									<fo:block font-family="Arial" font-size="10pt" language="EN-US"
										...
										<fo:inline font-size="12pt"><fo:leader leader-length="0pt"/>30 DAY CONTINUATION / FINAL REPORT REMINDER</fo:inline>
									</fo:block>
								</xsl:when>
								<xsl:when test="remType = 'rem60'">
									<fo:block font-family="Arial" font-size="10pt" language="EN-US"
										keep-with-next.within-page="always" text-align="center"
										font-weight="bold" letter-spacing="-0.15pt" text-decoration="underline">
										<fo:inline font-size="12pt"><fo:leader leader-length="0pt"/>60 DAY CONTINUATION / FINAL REPORT REMINDER</fo:inline>
									</fo:block>
								</xsl:when>
								<xsl:when test="remType = 'rem90'">
									<fo:block font-family="Arial" font-size="10pt" language="EN-US"
										keep-with-next.within-page="always" text-align="center"
										font-weight="bold" letter-spacing="-0.15pt" text-decoration="underline">
										<fo:inline font-size="12pt"><fo:leader leader-length="0pt"/>90 DAY CONTINUATION / FINAL REPORT REMINDER</fo:inline>
									</fo:block>
								</xsl:when>
							</xsl:choose>						
						</xsl:if>						
                        ...
                        <fo:block font-family="Arial" font-size="12pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>An Institutional Review Board (IRB) of the Icahn School of Medicine at Mount Sinai, approved the following human subject research to be conducted through <xsl:value-of select="$endDate"/>.</fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
						...
						<xsl:choose>
							<xsl:when test="remType = 'rem60'">
                                <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                                    ...
                                    xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                                    xmlns:svg="http://www.w3.org/2000/svg">
                                    <fo:inline color="black"><fo:leader leader-length="0pt"/>Keeping in mind the Program for Protection of Human Subjects (PPHS) submission deadline schedule (</fo:inline>
                                    ...
                                    <fo:inline color="black"><fo:leader leader-length="0pt"/>), please submit a Continuation or Final Report by:</fo:inline>
                                </fo:block>
						    </xsl:when>
                            <xsl:when test="remType = 'rem90'">
                                <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
						...
						<xsl:choose>
							<xsl:when test="remType = 'rem30'">
								...
								<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
									...
									xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
									xmlns:svg="http://www.w3.org/2000/svg">
									<fo:inline color="black"><fo:leader leader-length="0pt"/>The IRB requested that by <xsl:value-of select="concat(' ',remApprovalEndDate)"/> you submit a completed Continuing/Final Review Progress Report and required attachments to request continuing approval of study closure.</fo:inline>
								</fo:block>
							</xsl:when>
							<xsl:when test="remType = 'rem60'">
								<fo:block font-family="Arial" font-size="10pt" language="EN-US"
								...
								<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
									...
									xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
									xmlns:svg="http://www.w3.org/2000/svg">
									<fo:inline color="black" text-decoration="underline"><fo:leader leader-length="0pt"/>The PPHS submission deadline immediately prior to</fo:inline>
									<fo:inline color="black"><fo:leader leader-length="0pt"/> <xsl:value-of select="concat(' ',remApprovalEndDate)"/> or within 30 days of study closure, whichever is earlier, in order to request continuing IRB approval or study closure.</fo:inline>
								</fo:block>
							</xsl:when>
							<xsl:when test="remType = 'rem90'">
								<fo:block font-family="Arial" font-size="10pt" language="EN-US"
                        ...
                        <xsl:choose>
							<xsl:when test="remType = 'rem60'">
							    ...
							    xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
							    xmlns:svg="http://www.w3.org/2000/svg">
							    <fo:inline color="black"><fo:leader leader-length="0pt"/>If you do not submit a completed Continuation or Final Report to request continuing approval or study closure by <xsl:value-of select="remApprovalEndDate"/> you will not be able to submit new research to the PPHS until this information has been submitted.</fo:inline>							
						        </fo:block>	
                            </xsl:when>
                            <xsl:when test="remType = 'rem90'">
						        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
						...
						<xsl:when test="remType = 'rem30'">
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline color="black" ><fo:leader leader-length="0pt"/> If continuing review approval is not granted before the expiration date of <xsl:value-of select="$endDate"/> approval of this research expires on that date. If IRB approval expires, </fo:inline>
							<fo:inline color="black" text-decoration="underline"><fo:leader leader-length="0pt"/>all research activities must stop</fo:inline>
							<fo:inline color="black" ><fo:leader leader-length="0pt"/>. This includes recruitment, advertisement, screening, enrollment, consent, interventions, interactions, and collection of private identifiable information. Advertisements currently running in the media must be pulled.</fo:inline>
                            </fo:block>
                        </xsl:when>
                        <xsl:when test="remType = 'rem60'">
                            <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline color="black" ><fo:leader leader-length="0pt"/> If the Continuation submission is not approved before the expiration date of <xsl:value-of select="$endDate"/>, approval of this research expires on that date. If the IRB approval expires, </fo:inline>
							<fo:inline color="black" text-decoration="underline"><fo:leader leader-length="0pt"/>all research activities must stop</fo:inline>
							<fo:inline color="black" ><fo:leader leader-length="0pt"/>. This includes recruitment, advertisement, screening, enrollment, consent, interventions, interactions, and collection of private identifiable information. Advertisements currently running in the media must be pulled.</fo:inline>
                            </fo:block>
                        </xsl:when>
						...
						<xsl:when test="remType = 'rem30'">
							...
							xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
							xmlns:svg="http://www.w3.org/2000/svg">
							<fo:inline color="black"><fo:leader leader-length="0pt"/>If you have any questions about how to submit this request, need help with the process, or have general questions about the IRB, please feel free to call us at 212-824-8200 or email us at IRB@mssm.edu.</fo:inline>															
						    </fo:block>	
                        </xsl:when>
                        <xsl:when test="remType = 'rem60'">
                            <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
							...
							xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
							xmlns:svg="http://www.w3.org/2000/svg">
							<fo:inline color="black"><fo:leader leader-length="0pt"/>If you have any questions about how to submit this request, need help with the process, or have general questions, please feel free to call us at 212-824-8200 or email us at IRB@mssm.edu.</fo:inline>															
						    </fo:block>	
                        </xsl:when>
                        <xsl:when test="remType = 'rem90'">
                          	<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
