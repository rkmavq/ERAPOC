				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block widows="2" orphans="2" font-size="10pt" line-height="1.147" white-space-collapse="false">						
                                    ...
                                    <fo:table-cell padding-top="0pt" padding-left="0pt"
                                        ...
                                        <fo:block-container>
                                            <fo:block font-family="Arial" font-size="10pt"
                                                ...
                                                <fo:inline font-family="Arial"
                                                    letter-spacing="-0.15pt" font-size="10pt"
                                                    ><fo:leader leader-length="0pt"/>Individual Patient Expanded Access IND <xsl:value-of select="singlePatientINDNumber"/></fo:inline>
                                            </fo:block>
                                        </fo:block-container>
                                    </fo:table-cell>
                                </fo:table-row>   
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>Thank you for your submission of Individual Patient Expanded Access IND materials for this project. Upon reviewing the information and supporting documentation provided, you are now approved to use this drug in the manner stated in your FDA Form 3926 Individual Patient Expanded Access Investigational New Drug Application (IND) Form.</fo:inline>                                           
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>This submission has received Expedited Review based on applicable federal regulations.</fo:inline>                            
                        </fo:block>
					    ...
					    <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
					        ...
					        xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
					        xmlns:svg="http://www.w3.org/2000/svg">
					        <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>Additional Physician Responsibilities:  </fo:inline>
					    </fo:block>
					    ...
					    <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
					        ...
					        xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
					        xmlns:svg="http://www.w3.org/2000/svg">
					        <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>Following the use of the drug, a follow-up report should be submitted to the FDA in which summary information regarding patient outcome is presented (including any problems). When the follow-up report is submitted to the FDA, a copy should also be provided to the IRB office. </fo:inline>
					    </fo:block>
					    ...
					    <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
					        ...
					        xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
					        xmlns:svg="http://www.w3.org/2000/svg">
					        <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>A follow-up report providing summary information regarding patient outcome, must be submitted to the HonorHealth IRB within 6 months of the date of this approval. The following information must be included in the report:</fo:inline>
					    </fo:block>
                            ...
                            <fo:list-item space-after="5mm">
                                ...
                                <fo:list-item-body>
                                    <fo:block start-indent="2em">
                                        <fo:inline color="black"><fo:leader leader-length="0pt"/>A summary of the patient’s outcomes and current status, including any unanticipated problems or adverse events.</fo:inline>							
                                    </fo:block>
                                </fo:list-item-body>
                            </fo:list-item> 
                            <fo:list-item space-after="5mm">
                                ...
                                <fo:list-item-body>
                                    <fo:block start-indent="2em">
                                        <fo:inline color="black"><fo:leader leader-length="0pt"/>Current status of drug</fo:inline>							
                                    </fo:block>
                                </fo:list-item-body>
                            </fo:list-item>  
                            <fo:list-item space-after="5mm">
                                ...
                                <fo:list-item-body>
                                    <fo:block start-indent="2em">
                                        <fo:inline color="black"><fo:leader leader-length="0pt"/>Unanticipated problems involving the drug must be reported to the HonorHealth IRB. Please refer to HonorHealth Policy RE1505 Adverse Events and Unanticipated Problems.</fo:inline>							
                                    </fo:block>
                                </fo:list-item-body>
                            </fo:list-item>
                        </fo:list-block>	
					    ...
					    <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
					        ...
					        xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
					        xmlns:svg="http://www.w3.org/2000/svg">
					        <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>This follow-up report is due to the IRB no later than <xsl:value-of select="$endDate"/>.</fo:inline>
					    </fo:block>
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>Please note that any revisions to previously approved materials must be approved by this committee prior to initiation. Please use the appropriate revision forms for this procedure.</fo:inline>
                        </fo:block>
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>If you have any questions, please contact <xsl:value-of select="$contactName"/> at <xsl:value-of select="$contactPhone"/> or <xsl:value-of select="$contactEmail"/>. Please include your project title and study number in all correspondence with this committee.</fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
                        ...
                        <fo:block font-family="Arial" font-size="9pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" font-size="8pt"><fo:leader leader-length="0pt"/>This letter has been electronically signed in accordance with all applicable regulations, and a copy is retained within HonorHealth Institutional Review Board's records.</fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
