                ...
                <fo:block id="IDAKIOTD" xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                    ...
                    <fo:block id="IDALIOTD">
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            ...
                            <fo:inline font-size="12pt"><fo:leader leader-length="0pt"/>ADMINISTRATIVE NOTIFICATION</fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" text-align="justify" letter-spacing="-0.15pt">
                            <fo:leader/>
                        ...
                        <fo:block font-family="Arial" font-size="12pt" language="EN-US">
                            <fo:inline font-family="Arial" color="black" font-weight="bold" letter-spacing="-0.15pt" font-size="10pt"
                                ><fo:leader leader-length="0pt"/>This is an administrative notification of IRB review of this study. No research activities involving human subjects can commence until the IRB has confirmed notification of the receipt of research funding.</fo:inline>
                        </fo:block>
						<fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
                       ...
                       <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
							<fo:inline color="black" text-decoration="underline"><fo:leader leader-length="0pt"/>When funding has been received, </fo:inline>
                            <fo:inline color="black"><fo:leader leader-length="0pt"/>the PI must submit a memorandum to the IRB indicating whether any new information has come to light that would require a change within any of the documentation submitted by the PI, or might affect the IRB's assessment of the risk/benefit ratio (such as an article published in the literature that sheds new light on this research topic). If any new information has been received that would require a change in the research, please submit your request for modification to the IRB along with your clarifying memorandum.</fo:inline>
                        </fo:block>
						<fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
