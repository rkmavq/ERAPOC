                ...
                <fo:block id="IDAKIOTD" xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                    ...
                    <fo:block id="IDALIOTD">
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            ...
                            <fo:inline font-size="12pt"><fo:leader leader-length="0pt"/>IRB APPROVAL PERIOD SHORTENING</fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" text-align="justify" letter-spacing="-0.15pt">
                            <fo:leader/>
                        ...
                        <fo:block font-family="Arial" font-size="12pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>On <xsl:value-of select="$REVDate"/> the Program for Protection of Human Subjects of the Icahn School of Medicine at Mount Sinai and Mount Sinai Hospital, processed an administrative action, the shortening the IRB approval period to be in concert with the funding period.  The new IRB approval end date for the following human subject research is <xsl:value-of select="newApprovalEndDate"/> inclusive:</fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            <fo:inline color="black"><fo:leader leader-length="0pt"/><xsl:value-of select="newApprovalEndDate"/></fo:inline>
						...
						<xsl:if test="reviewLevel = 'expedited'">
							<fo:block font-family="Arial" font-size="10pt" language="EN-US"
								text-indent="36pt" letter-spacing="-0.15pt">
								<fo:leader/>
							</fo:block>
							...
							<xsl:for-each select="exemptCats">
								<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
								orphans="1" color="#000000" end-indent="0pt"
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
								xmlns:svg="http://www.w3.org/2000/svg">
