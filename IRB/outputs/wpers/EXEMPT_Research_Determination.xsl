                ...
                <fo:block id="IDAKIOTD" xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                    ...
                    <fo:block id="IDALIOTD">
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            ...
                            <fo:inline font-size="12pt"><fo:leader leader-length="0pt"/>HUMAN RESEARCH EXEMPT DETERMINATION</fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" text-align="justify" letter-spacing="-0.15pt">
                            <fo:leader/>
                        ...
                        <fo:block font-family="Arial" font-size="12pt" language="EN-US">
                            <fo:inline font-family="Arial" letter-spacing="-0.15pt" font-size="10pt"
                                ><fo:leader leader-length="0pt"/>On <xsl:value-of select="$meetingDate"/> the PPHS office determined that the following proposed activity is EXEMPT human research as defined by DHHS regulations (45 CFR 46. 101(b) 
								
								<xsl:if test="isExemptOnly = '1'">
								<xsl:choose>
									<xsl:when test="count(exemptCat) &gt; 0">
										<xsl:for-each select="exemptCat">
											<fo:block>
											<fo:inline><fo:leader leader-length="0pt"/>
												<fo:leader leader-length="0pt"/><fo:leader leader-length="0pt"/><xsl:value-of select="."/></fo:inline>
											</fo:block>
											</xsl:for-each>
									</xsl:when>
									<xsl:otherwise>
                        ...
                        <fo:block font-family="Arial" font-size="12pt" language="EN-US">
                            <fo:inline font-family="Arial" letter-spacing="-0.15pt" font-size="10pt"
                                ><fo:leader leader-length="0pt"/>This determination was made based solely on the information provided by the investigator in the Ideate application. </fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
						...
						<fo:block font-family="Arial" font-size="12pt" language="EN-US">
                            <fo:inline font-family="Arial" letter-spacing="-0.15pt" font-size="10pt"
                                ><fo:leader leader-length="0pt"/>Continuing review applications are not required for exempt projects.  Please submit a completed Final Report to close out the study once it has been completed. </fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
						...
						<fo:block font-family="Arial" font-size="12pt" language="EN-US">
                            <fo:inline font-family="Arial" letter-spacing="-0.15pt" font-size="10pt"
                                ><fo:leader leader-length="0pt"/>Should you wish to make modifications to the conduct of the research, including the type, nature, source, or mechanism of collection of the data or materials specified in the protocol, you must request review and approval of such changes in advance from the PPHS, except when necessary to eliminate apparent immediate hazards to the subjects.	</fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
						...
						<xsl:if test="requestingWaiverAlteration = '1'">
							...
							<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
								...
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
								xmlns:svg="http://www.w3.org/2000/svg">
								<fo:inline color="black"><fo:leader leader-length="0pt"/>The PPHS approved the request for Waiver of Authorization for use and disclosure of PHI for this project on </fo:inline>
							    <fo:inline color="black"><fo:leader leader-length="0pt"/><xsl:value-of select="$meetingDate"/><!--<xsl:value-of select="orgApprovalDate"/>--></fo:inline>
						...
						<xsl:if test="requestingWaiverAlteration = '2'">
							...
							<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
								...
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
								xmlns:svg="http://www.w3.org/2000/svg">
								<fo:inline color="black"><fo:leader leader-length="0pt"/>The PPHS  approved the request for Alteration of Authorization waiver of signature for use and disclosure of PHI for this project on </fo:inline>
							    <fo:inline color="black"><fo:leader leader-length="0pt"/><xsl:value-of select="$meetingDate"/><!--<xsl:value-of select="orgApprovalDate"/>--></fo:inline>
								<fo:inline color="black"><fo:leader leader-length="0pt"/>. This request was reviewed and approved by expedited review procedures. The PPHS determined that the waiver of authorization satisfies the following criteria:</fo:inline>								
							</fo:block>
						...
						<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
								...
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
								xmlns:svg="http://www.w3.org/2000/svg">
								<fo:inline color="black"><fo:leader leader-length="0pt"/>It is the responsibility of the investigator to ensure that all institutional policies regarding the conduct of the research are followed, including the PPHS education requirements, disclosures of any financial interests in the research (FCOI) and any required submission to the Grants and Contracts Office (GCO).</fo:inline>								
							</fo:block>	
