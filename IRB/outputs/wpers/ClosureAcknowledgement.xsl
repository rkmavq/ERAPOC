                ...
                <fo:block id="IDAKIOTD" xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                    ...
                    <fo:block id="IDALIOTD">
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            ...
                            <fo:inline font-size="12pt"><fo:leader leader-length="0pt"/>ACKNOWLEDGEMENT OF RESEARCH CLOSURE</fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                        ...
                        <fo:block font-family="Arial" font-size="12pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>On <xsl:value-of select="$subReceiptDate"/>, the PPHS received the notice of study closure:</fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
						...
						<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline color="black"><fo:leader leader-length="0pt"/>The PPHS acknowledges receipt of information about the closure of this research, which indicates: </fo:inline>
                        </fo:block>
						...
						<fo:block font-family="Arial" font-size="12pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" text-decoration="underline" font-size="10pt"><fo:leader leader-length="0pt"/>-	The research is permanently closed to enrollment. </fo:inline>
                        </fo:block>
						<fo:block font-family="Arial" font-size="12pt" language="EN-US" widows="1"
                            orphans="1" color="#000000" end-indent="0pt" text-indent="36pt" 
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" text-decoration="underline" font-size="10pt"><fo:leader leader-length="0pt"/>-	All subjects have completed all research-related interventions. </fo:inline>
                        </fo:block>
						<fo:block font-family="Arial" font-size="12pt" language="EN-US" widows="1"
                            orphans="1" color="#000000" end-indent="0pt" text-indent="36pt" 
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" text-decoration="underline" font-size="10pt"><fo:leader leader-length="0pt"/>-	Collection of private identifiable information is completed. </fo:inline>
                        </fo:block>
						<fo:block font-family="Arial" font-size="12pt" language="EN-US" widows="1"
                            orphans="1" color="#000000" end-indent="0pt" text-indent="36pt" 
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" text-decoration="underline" font-size="10pt"><fo:leader leader-length="0pt"/>-	Analysis of private identifiable information is completed. </fo:inline>
                        </fo:block>
