                ...
                <fo:block id="IDAKIOTD" xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                    ...
                    <fo:block id="IDALIOTD">
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            ...
                            <fo:inline font-size="12pt"><fo:leader leader-length="0pt"/>APPROVAL OF RESEARCH</fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" text-align="justify" letter-spacing="-0.15pt">
                            <fo:leader/>
                        ...
                        <fo:block font-family="Arial" font-size="12pt" language="EN-US" widows="1"
                            orphans="1" color="#000000" end-indent="0pt" text-indent="36pt" 
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>On <xsl:value-of select="$meetingDate"/>, an Institutional Review Board of the Icahn School of Medicine at Mount Sinai, in accordance with Mount Sinai&apos;s Federal Wide Assurances (FWA#00005656, FWA#00005651) to the Department of Health and Human Services approved the following human subject research from <xsl:value-of select="$startDate"/> until <xsl:value-of select="$endDate"/> inclusive:</fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
						...
						<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline color="black"><fo:leader leader-length="0pt"/>Keeping in mind the PPHS deadline schedule (</fo:inline>
                            <fo:inline color="black"><fo:leader leader-length="0pt"/><fo:basic-link external-destination="url('http://icahn.mssm.edu/research/resources/program-for-the-protection-of-human-subjects/researchers-palette/meeting-dates-and-deadlines')" color="blue" text-decoration="underline">http://icahn.mssm.edu/research/resources/program-for-the-protection-of-human-subjects/researchers-palette/meeting-dates-and-deadlines</fo:basic-link></fo:inline>
                            <fo:inline color="black"><fo:leader leader-length="0pt"/>), make your submission by the PPHS deadline immediately prior to <xsl:value-of select="approvalEndDateMinus42"/> or within 30 days of study closure, whichever is earlier, in order to request continuing IRB approval or study closure.</fo:inline>                            
                        </fo:block>
						<fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline color="black"><fo:leader leader-length="0pt"/>If IRB continuing review approval is not granted before the expiration date of </fo:inline>
                            <fo:inline color="black"><fo:leader leader-length="0pt"/><xsl:value-of select="$endDate"/></fo:inline>
                            <fo:inline color="black"><fo:leader leader-length="0pt"/>, IRB approval of this research expires on that date.</fo:inline>
                        </fo:block>
                         <!--JF:  2/10/17 RITDEV-209 Letter Template Changes-->
                         <!-- //JF:  7/14/17 RITDEV-725:CLONE - 9 letter template changes - Part 3 -->
						<!--<xsl:if test="riskLevel/@level = 'min' or riskLevel/@level = ''">-->
    					<xsl:if test="latestApplicationRisk = 'min' or latestApplicationRisk = ''">
							...
							<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
								...
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
								xmlns:svg="http://www.w3.org/2000/svg">
								<fo:inline color="black"><fo:leader leader-length="0pt"/>The IRB has determined that this research involves no greater than MINIMAL RISK. Minimal risk means that the probability and magnitude of harm or discomfort anticipated in the research are not greater in and of themselves than those ordinarily encountered in daily life or during the performance of routine physical or psychological examinations or tests (45 CFR46.102; 21 CFR 50.3k).</fo:inline>
							</fo:block>	
						</xsl:if>                                               
						 <!--JF:  2/10/17 RITDEV-209 Letter Template Changes-->
                         <!-- //JF:  7/14/17 RITDEV-725:CLONE - 9 letter template changes - Part 3 -->
                         <!-- <xsl:if test="riskLevel/@level != 'min'">  -->
                          <xsl:if test="latestApplicationRisk = 'greater'">      
							<fo:block font-family="Arial" font-size="10pt" language="EN-US"
								text-indent="36pt" letter-spacing="-0.15pt">
								<fo:leader/>
							</fo:block>
							<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
								...
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
								xmlns:svg="http://www.w3.org/2000/svg">
								<fo:inline color="black"><fo:leader leader-length="0pt"/>The IRB has determined that this research involves GREATER THAN minimal risk.  Minimal risk means that the probability and magnitude of harm or discomfort anticipated in the research are not greater in and of themselves than those ordinarily encountered in daily life or during the performance of routine physical or psychological examinations or tests (45 CFR46.102; 21 CFR 50.3k).</fo:inline>
							</fo:block>	
						</xsl:if>  
                       
                    
                     <!-- <xsl:if test="isExpedited = '1'"> -->
                     <!-- <xsl:if test="expedited = '1'"> -->   
                        <xsl:if test="latestExpeditedCats != ''">
                       <!-- //JF:  7/14/17 RITDEV-725:CLONE - 9 letter template changes - Part 3 #7/8/9 -->
							<fo:block font-family="Arial" font-size="10pt" language="EN-US"
								text-indent="36pt" letter-spacing="-0.15pt">
								<fo:leader/>
							</fo:block>
							<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
								...
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
								xmlns:svg="http://www.w3.org/2000/svg">
								<fo:inline color="black"><fo:leader leader-length="0pt"/>The IRB approved with research under </fo:inline>
								<fo:inline color="black" font-weight="bold"><fo:leader leader-length="0pt"/>expedited review procedure category(ies)</fo:inline>
							</fo:block>
							<!--<xsl:for-each select="exemptCat">-->
                            <xsl:for-each select="latestExpeditedCat">
								<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
								orphans="1" color="#000000" end-indent="0pt"
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
								xmlns:svg="http://www.w3.org/2000/svg">
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline color="black" font-weight="bold"><fo:leader leader-length="0pt"/>PLEASE NOTE: Any modifications to this project must be reported to the IRB for review and approval prior to implementation.</fo:inline>
                        </fo:block>
						...
						<xsl:if test="requestingWaiverAlteration = '1'">
							...
							<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
							    ...
							    <!--<fo:inline color="black"><fo:leader leader-length="0pt"/><xsl:value-of select="$REVDate"/></fo:inline>-->
                                <fo:inline color="black"><fo:leader leader-length="0pt"/><xsl:value-of select="$startDate"/></fo:inline>
						...
						<xsl:if test="requestingWaiverAlteration = '2'">
							...
							<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                                ...
                                <!-- //JF:  7/14/17 RITDEV-725:CLONE - 9 letter template changes - Part 3  micro Review Level -->
								<fo:inline color="black"><fo:leader leader-length="0pt"/>. This request was reviewed and approved by 
                                <xsl:value-of select="microReviewLevel"/> review procedures. The IRB determined that the waiver of authorization satisfies the following criteria:</fo:inline>								
							</fo:block>
						...
						<xsl:if test="obtainingHIPAAAuthorization = '0'">
                         ...
                         <!--JF:  2/1/17 RITDEV-209 Letter Template Changes-->
						<!--	<xsl:for-each select="dataRecord">-->
                            <xsl:for-each select="dataViewed">
								<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
								orphans="1" color="#000000" end-indent="0pt"
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
								xmlns:svg="http://www.w3.org/2000/svg">
					 ...
					 <!--JF:  3/14/17 RITDEV-209 Letter Template Changes-->
                     <!--<xsl:if test="HIVInfoInformedConsent = '1'">-->
                        <xsl:if test="irbHIVTesting = '1'">	
							<fo:block font-family="Arial" font-size="10pt" language="EN-US"
								text-indent="36pt" letter-spacing="-0.15pt">
								<fo:leader/>
							</fo:block>
						...
						<!-- //JF:  7/14/17 RITDEV-725:CLONE - 9 letter template changes - Part 3 HIV consent section will appear when, the Procedures> Research Requires HIV Testing =Yes using the IRBHIVTesting field-->
                      ...
                      <!--  <xsl:if test="irbHIVTesting = '1'"> -->
						...
						<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
							...
							xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
							xmlns:svg="http://www.w3.org/2000/svg">
							<fo:inline color="black"><fo:leader leader-length="0pt"/>In conducting this research you are required to follow the requirements listed in the </fo:inline>
							<fo:inline color="black" font-weight="bold"><fo:leader leader-length="0pt"/> Investigator Manual</fo:inline>
							<fo:inline color="black"><fo:leader leader-length="0pt"/>. If stamped approved consent forms are released and available in IDEATE, use copies of these forms to document consent.  IRB approval does not constitute or imply institutional support for the conduct of this research.</fo:inline>
							<xsl:if test="otherSite = 'Other'">
								<fo:inline color="black" font-weight="bold"><fo:leader leader-length="0pt"/>Additionally, all required local approvals at each site must be obtained prior to initiation. </fo:inline>								
							</xsl:if>	
						</fo:block>
