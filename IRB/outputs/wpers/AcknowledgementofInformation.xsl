                ...
                <fo:block id="IDAKIOTD" xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                    ...
                    <fo:block id="IDALIOTD">
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            ...
                            <fo:inline font-size="12pt"><fo:leader leader-length="0pt"/>ACKNOWLEDGEMENT OF INFORMATION </fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" text-align="justify" letter-spacing="-0.15pt">
                            <fo:leader/>
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US">
                            <fo:inline font-family="Arial" letter-spacing="-0.15pt" font-size="10pt"
                                ><fo:leader leader-length="0pt"/>On <xsl:value-of select="$subReceiptDate"/>, the IRB received the following information item(s):</fo:inline>
                        </fo:block>
						 ...
						 <fo:block font-family="Arial" font-size="12pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/>-	<xsl:value-of select="newInfoIncidentDescription"/>  </fo:inline>
                        </fo:block>
						 <fo:block font-family="Arial" font-size="10pt" language="EN-US">
                            <fo:inline font-family="Arial" letter-spacing="-0.15pt" font-size="10pt"
                                ><fo:leader leader-length="0pt"/>This report is in regard to:</fo:inline>
                        </fo:block>
						...
						<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline color="black"><fo:leader leader-length="0pt"/>This information item is not a report of:  </fo:inline>
                        </fo:block>
						...
						<fo:block font-family="Arial" font-size="12pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial"  font-size="10pt"><fo:leader leader-length="0pt"/>-	An unanticipated problem involving risks to subjects or others that occurred at ISMMS; </fo:inline>
                        </fo:block>
						<fo:block font-family="Arial" font-size="12pt" language="EN-US" widows="1"
                            orphans="1" color="#000000" end-indent="0pt" text-indent="36pt" 
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial"  font-size="10pt"><fo:leader leader-length="0pt"/>-	Serious or continuing non-compliance with the regulations or the requirements or determinations of the IRB; and </fo:inline>
                        </fo:block>
						<fo:block font-family="Arial" font-size="12pt" language="EN-US" widows="1"
                            orphans="1" color="#000000" end-indent="0pt" text-indent="36pt" 
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial"  font-size="10pt"><fo:leader leader-length="0pt"/>-	A suspension or termination of IRB approval. </fo:inline>
                        </fo:block>
						...
						<fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline color="black"><fo:leader leader-length="0pt"/>The IRB acknowledges receipt of this information, and requires no additional action on this matter. </fo:inline>
                        </fo:block>
