                ...
                <fo:block id="IDAKIOTD" xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                    ...
                    <fo:block id="IDALIOTD">
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            ...
                            <fo:inline font-size="12pt"><fo:leader leader-length="0pt"/>REVIEW OF NEW INFORMATION </fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" text-align="justify" letter-spacing="-0.15pt">
                            <fo:leader/>
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                         ...
                         <fo:block font-family="Arial" font-size="10pt" language="EN-US">
                            <fo:inline font-family="Arial" letter-spacing="-0.15pt" font-size="10pt"
                                ><fo:leader leader-length="0pt"/>On <xsl:value-of select="$subReceiptDate"/>, the PPHS received the following information item(s):</fo:inline>
                        </fo:block>
						...
						<fo:block font-family="Arial" font-size="10pt" language="EN-US">
                            <fo:inline font-family="Arial" letter-spacing="-0.15pt" font-size="10pt"
                                ><fo:leader leader-length="0pt"/>This is a report of:
                                <xsl:value-of select="addLetterTextMicro"/>
                                <!--JF:  7/28/17 RITDEV-725:CLONE - 9 letter template changes - Part 3 add Review of New information field "Additional Letter Text"-->
                                <!--<xsl:value-of select="newInfoDets"/>-->
									<!--<xsl:choose>
									<xsl:when test="count(newInfoDet) &gt; 0">
										<xsl:for-each select="newInfoDet">
											<fo:block>
						...
						<fo:block font-family="Arial" font-size="10pt" language="EN-US">
                            <fo:inline font-family="Arial" letter-spacing="-0.15pt" font-size="10pt"
                                ><fo:leader leader-length="0pt"/>This report is in regard to:
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
							...
							<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
								...
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
								xmlns:svg="http://www.w3.org/2000/svg">
								<fo:inline color="black"><fo:leader leader-length="0pt"/>On <xsl:value-of select="meetingDate"/>, Board <xsl:value-of select="bordAssigned"/> determined that the event described above constitute <xsl:value-of select="newInfoDets"/>. The IRB determined the following actions will be taken:</fo:inline>
								<xsl:choose>
									<xsl:when test="count(newInfoDet) &gt; 0">
										<xsl:for-each select="newInfoDet">
											<fo:block>
