<xsl:stylesheet version="1.1"
    ...
    <!-- june282017 - changed reference to 'Calibri,normal,700' to 'any,normal,700' to avoid warning
	removed fo:table, table-layout="auto" as not supported and causing many warnings and possible overflow in FOP
	(added table-layout="fixed")  from <fo:table to <fo:table table-layout="fixed"
    -->
            ...
            <fo:block widows="2" orphans="2" font-size="10pt" line-height="1.147"
                ...
                <fo:block id="IDAKIOTD" xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                    ...
                    <fo:block id="IDALIOTD">
                        <fo:table table-layout="fixed" xmlns:st1="urn:schemas-microsoft-com:office:smarttags" xmlns:svg="http://www.w3.org/2000/svg" font-family="any" language="EN-IN" start-indent="0pt">
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            ...
                            <fo:inline font-size="12pt"><fo:leader leader-length="0pt"/>EXTERNAL IRB APPROVAL OF HUMAN RESEARCH</fo:inline>
                        </fo:block>
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" text-align="justify" letter-spacing="-0.15pt">
                            <fo:leader/>
                        ...
                        <fo:block font-family="Arial" font-size="12pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline font-family="Arial" font-size="10pt"><fo:leader leader-length="0pt"/> The PPHS has permitted an external IRB review for the following human subject research: </fo:inline>
                        </fo:block>
                        ...
                        <fo:table table-layout="fixed" font-family="Arial" language="EN-US" start-indent="0pt">
						...
						<fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline color="black"><fo:leader leader-length="0pt"/>In accordance with the terms of Mount Sinai&apos;s Federal Wide Assurances to the Department of Health and Human Services (FWA#00005656, FWA#00005651), the PPHS has an agreement in place with  <xsl:value-of select="appTypeName"/> to rely on their review of this research.  Evidence has been provided that <xsl:value-of select="appTypeName"/> approved the above noted human subject research from <xsl:value-of select="$startDate"/> until <xsl:value-of select="$endDate"/> inclusive:    </fo:inline>  
                        </fo:block>
						<fo:block font-family="Arial" font-size="10pt" language="EN-US"
                            text-indent="36pt" letter-spacing="-0.15pt">
                            <fo:leader/>
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags"
                            xmlns:svg="http://www.w3.org/2000/svg">
                            <fo:inline color="black" text-decoration="underline"><fo:leader leader-length="0pt"/>Before <xsl:value-of select="approvalEndDateMinus42"/> or within 30 days prior to study close, whichever is earlier, you are to submit an updated IRB approval or study closure notification from <xsl:value-of select="appTypeName"/>, in order to notify Mount Sinai of the status of the human research. </fo:inline>
                            <fo:inline color="black"><fo:leader leader-length="0pt"/>If IRB continuing review approval is not granted before the expiration date of <xsl:value-of select="$endDate"/></fo:inline>
                        ...
                        <fo:block font-family="Arial" font-size="10pt" language="EN-US" widows="1"
                            ...
                            <fo:inline color="black" ><fo:leader leader-length="0pt"/>In conducting this research you are required to follow the requirements listed in the </fo:inline>
							 <fo:inline color="black" text-decoration="underline"><fo:leader leader-length="0pt"/>Investigator Manual. </fo:inline>
                        </fo:block>
						<fo:block font-family="Arial" font-size="10pt" language="EN-US"
							text-indent="36pt" letter-spacing="-0.15pt">
							<fo:leader/>
                        ...
                        <xsl:if test="externalIRBHIVTesting = '1'">	
							<fo:block font-family="Arial" font-size="10pt" language="EN-US"
								text-indent="36pt" letter-spacing="-0.15pt">
								<fo:leader/>
							</fo:block>
