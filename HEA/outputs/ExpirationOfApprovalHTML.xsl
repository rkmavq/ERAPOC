...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:param name="IRBName"></xsl:param>
	...
	<div id="descriptionDiv">
		...
		<b>If you have not already done so, please submit a completed Continuing/Final Review Progress Report and required attachments to request continuing approval or study closure.</b>
		<p/>
		
		If you have already submitted a Continuation/Final Report application in Ideate, please disregard this reminder notice.
		<br/><br/>
